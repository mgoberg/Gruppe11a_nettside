"use strict";
// CANVAS JS
const mehmetCanvas = document.getElementById("mehmetCanvas");
const ctx = mehmetCanvas.getContext("2d");
const stx = mehmetCanvas.getContext("2d");
const ytx = mehmetCanvas.getContext("2d");
const dtx = mehmetCanvas.getContext("2d");
const etx = mehmetCanvas.getContext("2d");
